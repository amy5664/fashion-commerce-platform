...
| 기능명 | 설명 | 기여도 |
|------|------|------|
| 전반 UI / 프론트 디자인 | 서비스 전반 UI 설계 및 프론트엔드 디자인 가이드 적용 | ⭐⭐⭐ |
| 관리자 정보 조회 | 관리자 계정 정보 조회 및 관리 기능 구현 | ⭐⭐⭐ |
| 관리자 상품 관리 | 관리자 상품 등록/수정/삭제(CRUD) 기능 구현 | ⭐⭐⭐ |
| 카테고리 관리 | 메인 화면 카테고리 기준 상품 분류 및 연동 처리 구현 | ⭐⭐⭐ |
| 관리자 마이페이지 | 관리자 마이페이지 프론트 화면 구현 | ⭐⭐ |
| 관리자 최근 리스트 | 관리자 마이페이지 내 최근 데이터 리스트 구현 | ⭐⭐ |
| 관리자 대시보드 | 관리자 대시보드 전체 설계 및 핵심 지표·현황 화면 구현 | ⭐⭐⭐ |
